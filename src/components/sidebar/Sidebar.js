      ...
      <header>
        <div className="image-text">
          ...
          <div className="text logo-text">
            <span className="name">KAIRASI STEELS & </span>
            <span className="profession">HARDWARES</span>
          </div>
        </div>
        <FontAwesomeIcon
          icon={faAngleRight}
      ...
      <div className="menu-bar">
        <div className="menu">
          <ul className="menu-links">
            ...
            <li
              className={`nav-link ${
                selectedView === "categories" ? "selected" : ""
              }`}
            >
              <Link
                to="/categories"
                onClick={() => handleSelectedView("categories")}
              >
            ...
            <li
              className={`nav-link ${
                selectedView === "providers" ? "selected" : ""
              }`}
            >
              <Link
                to="/providers"
                onClick={() => handleSelectedView("providers")}
              >
            ...
            <li
              className={`nav-link ${
                selectedView === "purchases" ? "selected" : ""
              }`}
            >
              <Link
                to="/purchases"
                onClick={() => handleSelectedView("purchases")}
              >
            ...
            <li
              className={`nav-link ${
                selectedView === "customers" ? "selected" : ""
              }`}
            >
              <Link
                to="/customers"
                onClick={() => handleSelectedView("customers")}
              >
